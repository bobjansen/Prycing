...
def simulate_gbm(S0, mu, sigma, number_of_paths, number_of_steps, T):
    ...
    output = [np.full(number_of_paths, S0)]
    for i in range(1, number_of_steps + 1):
        ...
        output.append(output[i - 1] * np.exp(drift + sigma * sqrt_dt * normals))
